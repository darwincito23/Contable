...
{
	/**
	 * @var string El layout por defecto para las views. Defaults to '//layouts/column2', meaning
	...
	/**
	 * Espefica las reglas de control de acceso.
	 * Este método es usado porel filtro 'accessControl'.
