...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'idRegistroContable'); ?>
		<?php echo $form->textField($model,'idRegistroContable',array('size'=>20,'maxlength'=>20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'idCuentaPUC'); ?>
		<?php echo $form->textField($model,'idCuentaPUC'); ?>
	</div>
